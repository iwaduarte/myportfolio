...
const { about, inlineBlock } = styles;
...
const About = props => (
  <div className={about}>
    <div>
      ...
      <img src="/meee.jpg" alt="The kid" style={{ width: '100%' }} />
      (Text aid by GitHub copilot)
      <p>
        See that beautiful kid over here. He is a nice kid. He had dreams that didn't come true and yet he did not give
        up.
      </p>
      <p>
        This kid was introduced to computers early on in his life. At age of 8? Maybe 9? Hard to remember. He was
        curious about and fascinated by it. His dad brought up and probably mentioned the magic word: games. He did not
        understand much. It was an era which people in his country did not have access to computers. Internet was
      ...
      <p>
        ...
        drive coming out of the tray). The pages were ludicrous and full of fun but for him somehow it appeared magical.
        The ability to understand machines and make them do what you want.
      </p>
      <p> He did not speak any English so most of his knowledge was limited to his mother tongue.</p>
      <p>
        He grows up to become a Computer Engineer. It was a very hard path. Full of struggles, and bad decisions but he
        kept on. One moment he almost left everything because he wanted to travel and see the world, somehow and with
        their parents guidance he managed to finish his degree. Maybe he would need that knowledge for the future.
      </p>
      <p>
        He was not the best but was eager to learn. He thought that he needed to have access to the core of knowledge
        and for that, he needed to learn English. The language that would open the gates to the world of technology. The
        language that would show him the wonders. That would make him a good developer.
      </p>
      ...
      <p>
        ...
        and asked to be hired for the amusement of the receptionist that asked him politely to leave. He annoyed someone
        at Canva asking to give him a chance. He learned when he was not working. He cold-called people. Sent thousands
        of resumes. Nothing seemed to work
      </p>
      <p>
      ...
      <p>
        He embraced the journey. He was offered a mentorship that showed him paths that he did not think were possible.
        He worked long hours. 16 sometimes. 12 hours straight most of the time. He absorbed knowledge. He got obsessed
        with the work. He wanted to master the profession. The boy helped the business become reality. At one point he
        even had a team that he could mentor himself.
      </p>
      <p>
